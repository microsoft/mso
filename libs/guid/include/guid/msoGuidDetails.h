  ...
  constexpr GUID StringToGuid(const GuidString& g) noexcept
  {
    return {
        static_cast<unsigned int>(
            (H2U[(int)g[0]] << 28) | (H2U[(int)g[1]] << 24) | (H2U[(int)g[2]] << 20) | (H2U[(int)g[3]] << 16)
            | (H2U[(int)g[4]] << 12) | (H2U[(int)g[5]] << 8) | (H2U[(int)g[6]] << 4) | H2U[(int)g[7]]),
        static_cast<unsigned short>(
            (H2U[(int)g[9]] << 12) | (H2U[(int)g[10]] << 8) | (H2U[(int)g[11]] << 4) | H2U[(int)g[12]]),
        static_cast<unsigned short>(
            (H2U[(int)g[14]] << 12) | (H2U[(int)g[15]] << 8) | (H2U[(int)g[16]] << 4) | H2U[(int)g[17]]),
