...
private:
	UnknownSample1(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class UnknownSample2 final
	: public Mso::UnknownObject<IBaseSample1, IBaseSample2>
{
	friend MakePolicy; // To allow constructor to be private or protected.
...
private:
	UnknownSample2(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
private:
	UnknownSample3(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
private:
	UnknownSample4(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class UnknownSample5 final
	: public Mso::UnknownObject<Mso::RefCountStrategy::WeakRef, IBaseSample1, IBaseSample2>
{
	friend MakePolicy; // To allow constructor to be private or protected.
...
private:
	UnknownSample5(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class UnknownSample6 final
	: public Mso::UnknownObject<Mso::RefCountStrategy::WeakRef, Mso::QueryCastDerived<UnknownSample6>, IBaseSample1, IBaseSample2>
{
	friend MakePolicy; // To allow constructor to be private or protected.
...
private:
	UnknownSample6(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
private:
	UnknownSample7(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class UnknownSample8 final
	: public Mso::UnknownObject<Mso::RefCountStrategy::NoRefCount, IBaseSample1>
{
public:
	UnknownSample8(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class UnknownSample9Base
	: public Mso::QueryCastList<IBaseSample1, IBaseSample2>
{
public:
	virtual int GetValue1() const noexcept override
	{
...
class UnknownSample91 final
	: public Mso::UnknownObject<UnknownSample9Base, IBaseSample3>
{
...
private:
	UnknownSample91(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	UnknownSample91(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	UnknownSample91(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
private:
	UnknownSample92(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	UnknownSample92(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	UnknownSample92(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
public:
	UnknownSample93(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	UnknownSample93(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	UnknownSample93(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
public:
	UnknownSample94(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	UnknownSample94(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	UnknownSample94(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
class UnknownSample12 final
	: public Mso::UnknownObject<Mso::RefCountStrategy::NoRefCountNoQuery, IBaseSample1>
{
public:
	UnknownSample12(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class AgileSample1 final
	: public Mso::AgileUnknownObject<IBaseSample1, IBaseSample2>
{
	friend MakePolicy; // To allow constructor to be private or protected.
...
private:
	AgileSample1(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class AgileSample2 final
	: public Mso::AgileUnknownObject<Mso::RefCountStrategy::WeakRef, IBaseSample1>
{
	friend MakePolicy; // To allow constructor to be private or protected.
...
private:
	AgileSample2(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class AgileSample3 final
	: public Mso::AgileUnknownObject<Mso::RefCountStrategy::NoRefCount, IBaseSample1>
{
public:
	AgileSample3(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class AgileSample41 final
	: public Mso::AgileUnknownObject<UnknownSample9Base, IBaseSample3>
{
...
private:
	AgileSample41(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	AgileSample41(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	AgileSample41(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
private:
	AgileSample42(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	AgileSample42(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	AgileSample42(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
public:
	AgileSample43(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}

	AgileSample43(bool& deleted, int param0) noexcept
		: Super(param0)
		, m_deleted(deleted)
	{
	}

	AgileSample43(bool& deleted, int param0, int param1) noexcept
		: Super(param0, param1)
		, m_deleted(deleted)
	{
	}
...
class SimpleUnknownSample1 final
	: public Mso::UnknownObject<Mso::RefCountStrategy::NoRefCount, ISimpleUnknownSample1>
{
public:
	SimpleUnknownSample1(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
{
public:
	SimpleUnknownSample2(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class SimpleUnknownSample3 final
	: public Mso::UnknownObject<Mso::RefCountStrategy::NoRefCount, ISimpleUnknownSample1, Mso::QueryCastChain<ISimpleUnknownSample21, ISimpleUnknownSample2>>
{
public:
	SimpleUnknownSample3(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class MyMemHeapUnknownSample1 final
	: public Mso::UnknownObject<StatefulAllocSimpleRefCount, IBaseSample1>
{
public:
	virtual int GetValue1() const noexcept override
	{
...
protected:
	...
	MyMemHeapUnknownSample1(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class MyMemHeapUnknownSample2 final
	: public Mso::UnknownObject<StatefulAllocWeakRefCount, IBaseSample1>
{
public:
	virtual int GetValue1() const noexcept override
	{
...
protected:
	...
	MyMemHeapUnknownSample2(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
TEST_CLASS(UnknownObjectTest)
{
	TEST_METHOD(UnknownObject_SimpleRefCount_OneBaseInterface)
	{
		bool deleted = false;
		{
			...
			Debug(TestAssert::AreEqual<uint32_t>(1, unknown1->RefCount()));

			Mso::TCntPtr<IBaseSample1> base1 = unknown1;
			TestAssert::AreEqual(1, base1->GetValue1());
			Debug(TestAssert::AreEqual<uint32_t>(2, unknown1->RefCount()));
		}
	...
	TEST_METHOD(UnknownObject_SimpleRefCount_TwoBaseInterfaces)
	{
		bool deleted = false;
		{
			...
			Debug(TestAssert::AreEqual<uint32_t>(3, unknown1->RefCount()));
		}
		TestAssert::IsTrue(deleted);
	}
	...
	TEST_METHOD(UnknownObject_SimpleRefCount_TwoBaseInterfacesAndDerived)
	{
		bool deleted = false;
		{
			...
			Debug(TestAssert::AreEqual<uint32_t>(4, unknown1->RefCount()));
		}
		TestAssert::IsTrue(deleted);
	}
	...
	TEST_METHOD(UnknownObject_WeakRefCount_ObjectWithWeakRefBase)
	{
		bool deleted = false;
		{
			...
			TestAssert::AreEqual(1, unknown1->GetValue1());
			Debug(TestAssert::AreEqual<uint32_t>(1, unknown1->GetWeakRef().RefCount()));

			Mso::TCntPtr<IBaseSample1> base1 = unknown1;
			Debug(TestAssert::AreEqual<uint32_t>(2, unknown1->GetWeakRef().RefCount()));

			Mso::ObjectWeakRef* obj1weakRef = query_cast<Mso::ObjectWeakRef*>(base1.Get());
			TestAssert::IsNotNull(obj1weakRef);
			Debug(TestAssert::AreEqual<uint32_t>(2, obj1weakRef->RefCount()));
		}
		TestAssert::IsTrue(deleted);
	}
	...
	TEST_METHOD(AgileUnknownObject_WeakRefCount)
	{
		bool deleted = false;
		{
...
#endif
			{
				...
				Debug(TestAssert::AreEqual<uint32_t>(1, agile1->GetWeakRef().RefCount()));

				Mso::TCntPtr<IBaseSample1> base1 = qi_cast<IBaseSample1>(agile1.Get());
				TestAssert::AreEqual(1, base1->GetValue1());
				Debug(TestAssert::AreEqual<uint32_t>(2, agile1->GetWeakRef().RefCount()));

#if !defined(__clang__) && !defined(__GNUC__)
				Mso::TCntPtr<IMarshal> marshal1 = qi_cast<IMarshal>(base1.Get());
				TestAssert::IsNotNull(marshal1.Get(), L"IMarshal must not be null.");
				Debug(TestAssert::AreEqual<uint32_t>(3, agile1->GetWeakRef().RefCount()));
				...
				Debug(TestAssert::AreEqual<uint32_t>(4, agile1->GetWeakRef().RefCount()));
#endif
...
// OM:2065596: Investigate why this test fails sth.exe for winrt nx64.
	...
	TEST_METHOD(AgileUnknownObject_SimpleRefCount_ThreadSafety)
	{
		...
		for (int testIteration = 0; testIteration < 20; ++testIteration)
		{
			...
			{
				threads.push_back(std::thread([&](size_t index) -> void
				{
					results[index] = qi_cast<IMarshal>(agile1.Get());
				}, i));
			}
	...
	TEST_METHOD(UnknownObject_query_cast_const_ref)
	{
		bool deleted = false;
		{
			...
			TestAssert::AreEqual(2, base2.GetValue2());
			{
				TestAssert::ExpectVEC([&]() noexcept
				{
					query_cast<const IBaseSample3&>(base1);
				});
			}
	...
	TEST_METHOD(UnknownObject_query_cast_const_ref_from_ref)
	{
		bool deleted = false;
		{
			...
			TestAssert::AreEqual(2, base2.GetValue2());
			{
				TestAssert::ExpectVEC([&]() noexcept
				{
					query_cast<const IBaseSample3&>(const_cast<IBaseSample1&>(base1));
				});
			}
			#endif //!__clang__ && !__GNUC__
	...
	TEST_METHOD(UnknownObject_MyMemHeap_SimpleRefCount)
	{
		...
		bool freeCalled = false;
		{
			...
			Mso::TCntPtr<IBaseSample1> unknown1 = Mso::MakeAlloc<MyMemHeapUnknownSample1, IBaseSample1>(&memHeap, /*ref*/deleted);
			TestAssert::AreEqual(1, unknown1->GetValue1());
		}
		TestAssert::IsTrue(deleted);
	...
	TEST_METHOD(UnknownObject_MyMemHeap_WeakRefCount)
	{
		...
		{
			MyMemHeap memHeap(/*ref*/allocCalled, /*ref*/freeCalled);
			Mso::TCntPtr<IBaseSample1> unknown1 = Mso::MakeAlloc<MyMemHeapUnknownSample2, IBaseSample1>(&memHeap, /*ref*/deleted);
			TestAssert::AreEqual(1, unknown1->GetValue1());
		}
		TestAssert::IsTrue(deleted);
		TestAssert::IsTrue(allocCalled);
