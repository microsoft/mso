...
{
public:
	WeakPtrSample1(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
...
class WeakPtrSample3 final
	: public Mso::RefCountedObject<Mso::RefCountStrategy::WeakRef, IWeakPtrSample3>
{
public:
	WeakPtrSample3(bool& deleted) noexcept
		: m_deleted(deleted)
	{
	}
